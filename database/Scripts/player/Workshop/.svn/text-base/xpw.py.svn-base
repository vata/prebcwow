...
def CalcXP(MOBLEVEL, PLAYERLEVEL, VICTIM_CREATURE_TYPE, ELITE):
    ...
    STARTXP =               0                  # Start XP value (to adjust initial XP value)
    ...
    #VICTIM_CREATURE_TYPE =  1
    #PLAYERLEVEL =          self.GetLevel()     # For use in Server Environment
    #PLAYERLEVEL =           1
    #MOBLEVEL =              parser [6]
    #ELITE =                 0
    MOBHEALTH =             MOBLEVEL * 10 + 30
    MOBMANA =               MOBLEVEL * 10 + 30
    MOBMINDAMAGE =          MOBLEVEL * 8
    MOBMAXDAMAGE =          MOBLEVEL * 9
    NPCFLAGS =              0
