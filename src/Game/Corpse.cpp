...
void
Corpse::Create( uint32 guidlow )
{
    Object::_Create(guidlow, HIGHGUID_CORPSE);
}

void
Corpse::Create( uint32 guidlow, Player *owner, uint32 mapid, float x, float y, float z, float ang )
{
...
Corpse::SaveToDB()
{
    std::stringstream ss;
    ss.rdbuf()->str("");
    ss << "REPLACE INTO corpses (guid, positionX, positionY, positionZ, orientation, "
		"zoneId, mapId, data) VALUES (" << GetGUIDLow() << ", '" 
