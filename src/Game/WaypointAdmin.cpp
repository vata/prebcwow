...
WaypointIndicator*
ChatHandler::SpawnWaypointIndicator (float x, float y, float z, uint32 index)
{
    WorldPacket data;
...
bool
ChatHandler::Command_WP_Info (const char *args)
{
...
void
ChatHandler::_recreateCreatureWaypointIndicators (Creature *cr)
{
	if (cr == NULL) return;
...
void
ChatHandler::_resaveWaypoints (Creature *cr) 
{
...
bool
ChatHandler::Command_WP_Show (const char *args)
{
...
bool
ChatHandler::Command_WP_Hide (const char *args)
{
...
bool
ChatHandler::Command_WP_Come (const char *args)
{
	// Find GUID for current selection
	uint64 guid = m_session->GetPlayer()->GetSelection();
	if (guid == 0) {
...
bool
ChatHandler::Command_WP_Clear (const char *args)
{
	// Find GUID for current selection
	uint64 guid = m_session->GetPlayer()->GetSelection();
	if (guid == 0) {
...
bool
ChatHandler::Command_WP_Add (const char* args)
{
	uint64 guid = m_session->GetPlayer()->GetSelection();
	if (guid == 0) {
...
bool
ChatHandler::Command_NPC_Turn (const char *args)
{
	// Find GUID for current selection
	uint64 guid = m_session->GetPlayer()->GetSelection();
	if (guid == 0) {
...
bool
ChatHandler::Command_NPC_Come (const char *args)
{
	// Find GUID for current selection
	uint64 guid = m_session->GetPlayer()->GetSelection();
	if (guid == 0) {
...
bool
ChatHandler::Command_WP_Wait (const char *args)
{
	// Find GUID for current selection
	uint64 guid = m_session->GetPlayer()->GetSelection();
	if (guid == 0) {
