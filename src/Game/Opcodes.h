...
enum Opcodes {
	...
	SMSG_WARDEN_DATA                    = 744,  //(0x2E8)
	CMSG_WARDEN_DATA                    = 745,  //(0x2E9)
	SMSG_GROUP_JOINED_BATTLEGROUND      = 746,  //(0x2EA)
	MSG_BATTLEGROUND_PLAYER_POSITIONS   = 747,  //(0x2EB)
	CMSG_PET_STOP_ATTACK                = 748,  //(0x2EC)
	SMSG_BINDER_CONFIRM                 = 749,  //(0x2ED)
	SMSG_BATTLEGROUND_PLAYER_JOINED     = 750,  //(0x2EE)
	SMSG_BATTLEGROUND_PLAYER_LEFT       = 751,  //(0x2EF)
	CMSG_BATTLEMASTER_JOIN              = 752,  //(0x2F0)
	SMSG_ADDON_INFO                     = 753,  //(0x2F1)
	CMSG_PET_UNLEARN                    = 754,  //(0x2F2)
	SMSG_PET_UNLEARN_CONFIRM            = 755,  //(0x2F3)
	SMSG_PARTY_MEMBER_STATS_FULL        = 756,  //(0x2F4)
	CMSG_PET_SPELL_AUTOCAST             = 757,  //(0x2F5)
	SMSG_WEATHER                        = 758,  //(0x2F6)
	SMSG_PLAY_TIME_WARNING              = 759,  //(0x2F7)
	SMSG_MINIGAME_SETUP                 = 760,  //(0x2F8)
	SMSG_MINIGAME_STATE                 = 761,  //(0x2F9)
	CMSG_MINIGAME_MOVE                  = 762,  //(0x2FA)
	SMSG_MINIGAME_MOVE_FAILED           = 763,  //(0x2FB)
	NUM_MSG_TYPES                       = 764,  //(0x2FC)
};
