...
void
WorldSession::HandleGuildQueryOpcode(WorldPacket& recvPacket)
{
	uint32 guildId;
	Guild *guild;

	sLog.outDebug( "WORLD: Recieved CMSG_GUILD_QUERY"  );
	recvPacket >> guildId;
...
void
WorldSession::HandleGuildCreateOpcode(WorldPacket& recvPacket)
{
	WorldPacket data;
	std::string gname;
	Guild *guild;

	sLog.outDebug( "WORLD: Recieved CMSG_GUILD_CREATE"  );
...
void
WorldSession::HandleGuildInviteOpcode(WorldPacket& recvPacket)
{
	WorldPacket data;
	...
	sLog.outDebug( "WORLD: Recieved CMSG_GUILD_INVITE"  );

	recvPacket >> Invitedname;

	player = objmgr.GetPlayerByName(Invitedname.c_str());
...
void
WorldSession::HandleGuildRemoveOpcode(WorldPacket& recvPacket)
{
	...
	sLog.outDebug( "WORLD: Recieved CMSG_GUILD_REMOVE"  );
	
	recvPacket >> plname;

	player = objmgr.GetPlayerByName(plname.c_str());
	guild = objmgr.GetGuildById(GetPlayer()->GetGuildId());	
	if(!guild)
	{
		SendCommandResult(GUILD_CREATE_S,"",GUILD_PLAYER_NOT_IN_GUILD);
...
void
WorldSession::HandleGuildAcceptOpcode(WorldPacket& recvPacket)
{
	WorldPacket data;
	Guild *guild;
	MemberSlot *memslot;
	
	sLog.outDebug( "WORLD: Recieved CMSG_GUILD_ACCEPT"  );
...
void
WorldSession::HandleGuildDeclineOpcode(WorldPacket& recvPacket)
{
	WorldPacket data;
	sLog.outDebug( "WORLD: Recieved CMSG_GUILD_DECLINE"  );
...
void
WorldSession::HandleGuildInfoOpcode(WorldPacket& recvPacket)
{
	Guild *guild;
	WorldPacket data;
	sLog.outDebug( "WORLD: Recieved CMSG_GUILD_INFO"  );
...
void
WorldSession::HandleGuildRosterOpcode(WorldPacket& recvPacket)
{
	Guild *guild;
	
	sLog.outDebug( "WORLD: Recieved CMSG_GUILD_ROSTER"  );
...
void
WorldSession::HandleGuildPromoteOpcode(WorldPacket& recvPacket)
{
	WorldPacket data;
	std::string name;
	Player * player;
	...
	sLog.outDebug( "WORLD: Recieved CMSG_GUILD_PROMOTE"  );
	
	recvPacket >> name;

	player = objmgr.GetPlayerByName(name.c_str());
	guild = objmgr.GetGuildById(GetPlayer()->GetGuildId());	
	if(!guild)
	{
		SendCommandResult(GUILD_CREATE_S,"",GUILD_PLAYER_NOT_IN_GUILD);
...
void
WorldSession::HandleGuildDemoteOpcode(WorldPacket& recvPacket)
{
	WorldPacket data;
	std::string name;
	Player * player;
	...
	sLog.outDebug( "WORLD: Recieved CMSG_GUILD_DEMOTE"  );
...
void
WorldSession::HandleGuildLeaveOpcode(WorldPacket& recvPacket)
{
	WorldPacket data,data2;
	std::string plname;
	Guild *guild;
	
	sLog.outDebug( "WORLD: Recieved CMSG_GUILD_LEAVE"  );
...
void
WorldSession::HandleGuildDisbandOpcode(WorldPacket& recvPacket)
{
	WorldPacket data;
	std::string name;
	Guild *guild;

	sLog.outDebug( "WORLD: Recieved CMSG_GUILD_DISBAND"  );
...
void
WorldSession::HandleGuildLeaderOpcode(WorldPacket& recvPacket)
{
	WorldPacket data;
	std::string name;
	Player * player;
	...
	sLog.outDebug( "WORLD: Recieved CMSG_GUILD_LEADER"  );
...
void
WorldSession::HandleGuildMOTDOpcode(WorldPacket& recvPacket)
{
	WorldPacket data;
	Guild *guild;
	std::string MOTD;
	
	sLog.outDebug( "WORLD: Recieved CMSG_GUILD_MOTD"  );
...
void
WorldSession::HandleGuildSetPublicNoteOpcode(WorldPacket& recvPacket)
{
	...
	sLog.outDebug( "WORLD: Recieved CMSG_GUILD_SET_PUBLIC_NOTE"  );
...
void
WorldSession::HandleGuildSetOfficerNoteOpcode(WorldPacket& recvPacket)
{
	...
	sLog.outDebug( "WORLD: Recieved CMSG_GUILD_SET_OFFICER_NOTE"  );
...
void
WorldSession::HandleGuildRankOpcode(WorldPacket& recvPacket)
{
	WorldPacket data;
	Guild *guild;
	std::string rankname;
	...
	sLog.outDebug( "WORLD: Recieved CMSG_GUILD_RANK"  );
...
void
WorldSession::HandleGuildAddRankOpcode(WorldPacket& recvPacket)
{
	WorldPacket data;
	Guild *guild;
	std::string rankname;
	
	sLog.outDebug( "WORLD: Recieved CMSG_GUILD_ADD_RANK"  );
...
void
WorldSession::HandleGuildDelRankOpcode(WorldPacket& recvPacket)
{
	WorldPacket data;
	Guild *guild;
	std::string rankname;
	
	sLog.outDebug( "WORLD: Recieved CMSG_GUILD_DEL_RANK"  );
...
void
WorldSession::SendCommandResult(uint32 typecmd,std::string str,uint32 cmdresult)
{
	WorldPacket data;
