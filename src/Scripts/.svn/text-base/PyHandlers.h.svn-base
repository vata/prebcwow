...
typedef stdext::hash_map<uint32, AIModuleInfo *> AIModuleInfoMap;
...
typedef stdext::hash_map<uint32, uint32> NPCTextAssocMap;
typedef stdext::hash_map<uint32, string> TextAssocMap;
...
typedef stdext::hash_map<uint32, GossipModuleInfo *> GossipModuleInfoMap;
extern GossipModuleInfoMap		g_GossipMap;

typedef stdext::hash_map<uint32, QuestItemModuleInfo *> QuestItemModuleInfoMap;
extern QuestItemModuleInfoMap	g_ItemMap;

typedef stdext::hash_map<uint32, QuestGOModuleInfo *> QuestGOModuleInfoMap;
extern QuestGOModuleInfoMap		g_GOMap;;

typedef stdext::hash_map<uint32, QuestTriggerModuleInfo *> QuestTriggerModuleInfoMap;
extern QuestTriggerModuleInfoMap g_TriggerMap;

AIModuleInfo *GetAIModule (uint32 creatureId);
GossipModuleInfo *GetGossipModule (uint32 objId);
QuestItemModuleInfo *GetQuestItemModule (uint32 objId);
QuestGOModuleInfo *GetQuestGOModule (uint32 objId);
QuestTriggerModuleInfo *GetQuestTriggerModule (uint32 objId);
...
SpellHandlerInfo *GetSpellHandler (uint32 spellId);
typedef stdext::hash_map<uint32, SpellHandlerInfo *> SpellHandlerInfoMap;
extern SpellHandlerInfoMap	g_spellMap;

//-----------------------------------------------------------------------------
typedef stdext::hash_map<uint32, PyObject *> AuraHandlerMap;
